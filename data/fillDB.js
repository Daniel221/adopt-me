...
const userTableQuery = 'CREATE TABLE users (userid smallserial primary key, timestamp text, googleid text, name varchar(50), lastname varchar(50), email varchar(50), img text);';
